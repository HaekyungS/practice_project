...
const textTitleProps = {
  style: "width:80%; height:20%; text-align:center; font-size:33px",
...
form.addEventListener("submit", (event) => {
  if (count === 0) {
    ...
    Box.style.height = "80%";
    textTitle.innerText =
      "2023년 11월 01일 레볼루션 하트 막내 류님의 생일을 맞아, 류님과 관련한 문제들로 모의고사를 준비하였습니다. 총 11개의 객관식 문제들로 구성되어 있으며, 문제들은 류님의 나무위키, 생방송, 유튜브 를 기반으로 출제하였습니다. 너네가 나에 대해 몰 알아! 귀여운 건 알아! 시험을 시작합니다.";
    input.value = "ㄱㅂㅈㄱ";
    return count++;
  } else {
  }
